...
public class Defend {
    ...
    public Card chooseCard(ArrayList<Card> playerHand, Card attackingCard, Suit trump) {
        Boolean askAgain = true;
        Scanner in = new Scanner(System.in);
        Card defendingCard = null;

        do  {
            System.out.println("Player 2 pick a card to defend the attack ("+ attackingCard.toString() +") with or enter 0 to fold");
                ...
                if (parts.length == 2) {
                    ...
                    if (!isValidCard) {
                        ...
                        if (chosenSUIT == attackingCard.getSuit()) {
                            ...
                            if (compareValue > 0) {
                                System.out.println("Player 1 defended the attack with " + defendingCard.toString());
                                askAgain = false;
                            } else {
